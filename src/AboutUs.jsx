...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Green Haven Nursery, where every plant finds its perfect home!</p>
      <p className="about-us-content">
        At Green Haven Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Green Haven Nursery today and experience the 
